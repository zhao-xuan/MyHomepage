...
function ActivityItem(props) {
    return  <div className="resume-item wow fadeInUp" data-wow-delay="0.3s">
                ...
                <img loading="lazy" src={props.activityImage} />
            </div>
}
    ...
    activityList = [
        {
            ...
            activityImage : "../static/img/pulsesecurelogo.jpg"
        }, {
            ...
            activityImage : "../static/img/autodesklogo.png"
        }, {
            ...
            activityImage : "../static/img/ichacklogo.png"
        }, {
            ...
            activityImage : "../static/img/openwrtdemo.png"
        }, {
            ...
            activityImage : "../static/img/imperiallogo1.jpg"
        }
    ]
